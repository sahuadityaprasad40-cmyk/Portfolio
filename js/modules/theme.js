/**
 * APEX TELEMETRY - THEME MANAGEMENT MODULE
 * Toggles between Obsidian Dark Mode (default) and High-Visibility Light Mode.
 */
...
export function applyTheme(theme) {
  ...
  if (toggleBtn) {
    ...
    toggleBtn.innerHTML = isDark 
      ...
      : `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg><span>OBSIDIAN</span>`;
